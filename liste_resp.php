...
<body>
	<div id="headeur"> <h1>STAG <br />Informations Sportives - IUT Nice</h1></div>
		...
		<table><tr><td>Login</td><td>Mot de Pass</td><td>Sport</td><td>Email</td>';
		
		while($tabresult = mysql_fetch_assoc($result)){
			echo'
			<tr><td>';echo $tabresult["login"];echo'</td><td>'; echo $tabresult["pass"];echo'</td><td>'; echo $tabresult["sport"];echo'</td><td>'; echo $tabresult["mail"];  echo'</td></tr>';
		} ?>
			</table>

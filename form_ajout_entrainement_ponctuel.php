...
<body>
	<div id="headeur"> <h1>STAG <br />Informations Sportives - IUT Nice</h1></div>
		...
		<div id="form_new_client">
			<form name="form1" method="post" action="ajout_entrainement_ponctuel.php">	
				...
				<p align="left">Année (aaaa) :	
				<input name="annee" type="text" id="annee" size="4"><br />
				</p>
				<input align="center" type="submit" name="Submit" value="Enregistrer l'Entraînement">
			</form>
		</div>
